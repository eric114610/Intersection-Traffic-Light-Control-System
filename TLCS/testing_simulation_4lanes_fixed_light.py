...
class Simulation:
    ...
    def run(self, episode):
        ...
        while self._step < self._max_steps:
            ...
            current_state, emer_n, emer_e, emer_w, emer_s = self._get_state()
    ...
    def _choose_action(self, state, emer_n, emer_e, emer_w, emer_s):
        """
        ...
        action = 0
        if self._step % 100 < 40:
            action = 0
        elif self._step % 100 < 50:
            action = 1
        elif self._step % 100 < 90:
            action = 2
    ...
    def _get_state(self):
        ...
        for car_id in car_list:
            ...
            vCalss = traci.vehicle.getVehicleClass(car_id)
            ...
            if vCalss == "emergency" and Speed == 0:
                if lane_group == 0 or lane_group == 1:
                    emer_w = True
                if lane_group == 2 or lane_group == 3:
                    emer_n = True
                if lane_group == 4 or lane_group == 5:
                    emer_e = True
                if lane_group == 6 or lane_group == 6:
                    emer_s = True

        return state, emer_n, emer_e, emer_w, emer_s
