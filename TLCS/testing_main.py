...
from testing_simulation10 import Simulation
from generator import TrafficGenerator
from model import TestModel
from visualization import Visualization
from utils import import_test_configuration, set_sumo, set_test_path
from testing_simulation2 import Simulation as Simulation22
...
if __name__ == "__main__":
    ...
    simulation_time, total_waiting_time = Simulation1.run(config['episode_seed'])  # run the simulation
    ...
    simulation_time, total_waiting_time = Simulation2.run(config['episode_seed'])  # run the simulation
    print('Simulation time:', simulation_time, 's')
